        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxExemptionNumber = table.Column<string>(type: "text", nullable: true),
                    TaxExemptionCertificateUrl = table.Column<string>(type: "text", nullable: true),
                    TaxExemptionExpiryDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DefaultPaymentDueDays = table.Column<int>(type: "integer", nullable: true),
                    EarlyPaymentDiscountPercent = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundedByUserId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_RefundedByUserId",
